...
public class ScoresProvider extends ContentProvider {
    ...
    private static final int MATCHES_WITH_DATE_QUERY = 104;
    ...
    private static final String SCORES_STARTING_WITH_DATE = DatabaseContract.scores_table.DATE_COL + " >= ? ";
    ...
    private int match_uri(Uri uri) {
        String link = uri.toString();
        {
            if (link.contentEquals(DatabaseContract.BASE_CONTENT_URI.toString())) {
                ...
                return MATCHES_WITH_DATE_QUERY;
            }
        }
        return -1;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            ...
            case MATCHES_WITH_LEAGUE:
                ...
                break;
            case MATCHES_WITH_DATE_QUERY:
                retCursor = getScoresStartingWithDate(uri, projection, sortOrder);
                break;
            default:
                throw new UnsupportedOperationException("Unknown Uri" + uri);
        }
    ...
    private Cursor getScoresStartingWithDate(Uri uri, String[] projection, String sortOrder) {
